...
1. *Test* di *implicit prompting* su REST API `/ask` per traduzione ITA->ENG, contrari, ...
2. Creazione enumeratori `Artifact.java` e `Sentiment.java` 
3. Creazione modello richiesta per artefatto `ArtifactRequest.java`
4. Creazione prompt template per sentiment analysis di tipo *0-shot*
